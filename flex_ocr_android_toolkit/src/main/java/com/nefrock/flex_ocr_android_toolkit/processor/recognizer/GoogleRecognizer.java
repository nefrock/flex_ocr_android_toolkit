...
public class GoogleRecognizer implements Recognizer {
    ...
    public GoogleRecognizer(boolean useJP) {
        if(useJP) {
    ...
    @Override
    public void process(Bitmap bitmap, DetectorResult detectorResult, FlexScanOption option, OnScanListener<FlexScanResults> listener) {
